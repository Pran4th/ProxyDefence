        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <NewsCard
              ...
              description="Multiple banking institutions report coordinated proxy-based attacks originating from distributed sources."
              timestamp="2 hours ago"
              severity="high"
            />
            <NewsCard
              title="New proxy detection algorithm reduces false positives by 89%"
              description="ProxyDefence AI successfully identifies sophisticated proxy chains with unprecedented accuracy."
